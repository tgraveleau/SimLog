 ...
 // dimensions (arbitraires) d'une zone d'intersection pour la PlaInterface
  ...
  /**
	...
	public SimLogPlaCanvas(SimLogPla parent, int nv , int nm)	{
	  ...
	  //dimension des X : on multiplie par deux car on a deux colonnes par variables (var+n�gation)
  ...
  public void mouseClicked(MouseEvent e) {
    ...
    if ( ( divY >= 0 ) && ( divX <= NbVar * 2 ) && ( divY < NbMonome) ) {
			// v�rification que l'on n'a pas une variable et sa n�gation sur la meme ligne
			if (( divX % 2 ) == 0 ) {
