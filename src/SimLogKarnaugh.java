...
public class SimLogKarnaugh
{
  ...
  // Table des Correspondances entre la Table de Bool�ens et la Table de Karnaugh
...
/**********************************************************************************/
  ...
  // On Teste si le Masque M est un "Sous Masque" d'un Masque Accept� et Stock� dans StockMask
...
return NbMask;
  ...
  // Fonction qui Teste si un Masque peut �tre Appliqu� � Partir de sa Table CaseMask
  ...
  public int [][] regroupement ( int[][]StockMask , int NbMask )
    {
      ...
      // D�finition des Variables pour la Table qui Contient les Cases d'un Masque
      ...
      if ( ValidMask( CaseMask , NbLigCaseMask ) )
      ...
      else
        {
          ...
          // On G�n�re la Table de V�rit� qui Donne les Positions des Colonnes non Vide
	...
	//une fois tous les masques trouv�s, il faut enlever les masques qui sont des intersections
