...
public class SimLogAnaSynt {
	...
	public boolean isCorrect() {
		if (nbrErrors != 0)
			return false;
		if (nbrOpenPar != nbrClosePar)
			return false;
		return true;
	}

	/**
	 * return next character, this is the main function of the syntaxic analyzer
	 *
	...
	/**
	 * return the stack containing the expression that has been analyzed. The
	 * expression es given in the postfix notation.
	 *
