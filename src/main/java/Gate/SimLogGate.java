...
public abstract class SimLogGate extends Rectangle {
	...
	public final static String[] genericName = { "NONE", "AND", "NAND", "OR",
			"NOR", "XOR", "NOT", "SWITCH", "LED", "" };
...
//	public final static int STATE_MOVING = 2;
	...
	public SimLogLink inputLinks[]; // array of input ports
	 ...
	 *
	 * @return <code>FALSE</code> means false, <code>TRUE</code> means true and
	 *         <code>UNSET</code> means not yet defined
	 */
	 ...
	 *
	 * @param n
	 *            is either <code>FALSE</code>, <code>TRUE</code> or
	 *            <code>UNSET</code>
	 */
...
//	}
	...
	/**
	 * return maximum number of inputs ports (also equal to number of allowed
	 * links)
	 *
	...
	/**
	 * return number of free input port (used when trying to add a new link)
	 *
	 ...
	 *            link to add
	 * @param n
	 *            input port on which the link is being added
	 */
	...
	/**
	 * Add Link from output gate to this input gate. The output gate can not be
	 * of type <code>LED_GATE</code> and this gate can not be of type
	 * <code>SWITCH_GATE</code>
	 *
	 * @param lnk
	 *            link to add
	 */
	 ...
	 *
	 * @param _x
	 *            coordinate of gate on canvas
	 * @param _y
	 *            coordinate of gate on canvas
	 * @return <code>true</code> if both gates intersect <code>false</code>
	 *         otherwise
	 */
	 ...
	 *
	 * @param g
	 *            gate from which the link comes from
	 * @param port
	 *            input port of gate where the link is connected
	 */
	 ...
	 *
	 * @return <code>true</code> if all inputs are connected, <code>false</code>
	 *         otherwise
	 */
	 ...
	 *
	 * @return <code>true</code> if output is connected, <code>false</code>
	 *         otherwise
	 */
	...
	private int getInputYPos(SimLogGate g) {
		...
		for (i = 0; i < maxInputLinks; i++) {
			link = inputLinks[i];
			if (link.getOutputGate() == g)
				return y + inputYPos + i * STEP;
		}
		return 0;
	}
