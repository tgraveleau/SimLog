...
public class SimLogNameLEDWin extends JDialog
    ...
    private JPanel createButtonPanel( ) {
   	...
   	public void centerComponent( ) {
		...
		public SimLogNameLEDWin( SimLogWin win ) {
			super(win, true );
			setTitle("New LED name");
			appli=win;
    ...
    public boolean getState( ) {
		...
		private boolean alreadyExistsName() {
			...
			s.trim();
			if (appli.getCircuit().findGateByName(s)!=null) return true;
			return false;
		}
