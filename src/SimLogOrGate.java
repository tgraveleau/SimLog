...
public class SimLogOrGate extends SimLogGate {
		...
		private static int poly_x[] = { 0, 10, 20, 25, 30, 25, 20, 10,  0,  3,  6, 3, 0 };
		private static int poly_y[] = { 0,  0,  5, 10, 15, 20, 25, 30, 30, 25, 15, 5, 0 };
		...
		public void compute() {
				...
				for (i = 0; i < maxInputLinks; i++) {
					...
					if (gate.getValue() == SimLogGate.TRUE) value = SimLogGate.TRUE;
				}
		}
}