...
public class SimLogRenSwitchWin extends JDialog implements ActionListener {
	...
	public SimLogRenSwitchWin(JFrame parent, SimLogGate g, SimLogCircuit c) {
		...
		initialValue = g.getName().charAt(0) - 65;
		getContentPane().add("Center",
				createMessagePanel(tab, initialValue, g.getName()));
